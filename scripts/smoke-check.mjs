...
const required = [
  ...
  "data/research/report_presets.json",
  "data/research/series_library.json",
  "data/research/public_provider_library.json",
...
async function run() {
  ...
  const htmlChecks = [
    ...
    'id="externalCsvUrl"',
    'id="presetSelect"',
    'id="providerSeriesSelect"',
    'id="addProviderSeries"',
    'id="librarySearch"',
    'id="libraryTable"',
    'id="sceneBg"',
    "three.min.js",
  ...
  const jsChecks = [
    ...
    "function fetchBeaSeries(",
    "function fetchTreasurySeries(",
    "function fetchCensusSeries(",
